...
|---|---|---|---|---|---|---|
| F1 | Adobe MCP rejected the Higgsfield cloudfront URL | integration | Adobe only accepts assets in its own trusted storage | upload via asset handshake OR mark Adobe-MAX AMBER-needs-upload | QUEUED | R1: never call Adobe image tools on a non-whitelisted URL; upload first |
