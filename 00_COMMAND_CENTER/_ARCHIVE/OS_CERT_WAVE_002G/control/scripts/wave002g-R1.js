export const meta = {
  name: 'wave002g-R1',
  description: 'Wave 002-G: whole-read + segment-ledger certify books, extract 5-field doctrine, adversarially verify',
  phases: [
...
const BOOKS = [{"slug": "stephen_shore_the_nature_of_photographs_", "title": "Stephen Shore - The Nature Of Photographs (2007, Phaidon Press) - libgen.li.pdf", "parts": 1, "units": [{"part": 1, "file": "/tmp/wave002g/parts/stephen_shore_the_nature_of_photographs__p1.txt", "words": 7324}]}, {"slug": "jonathan_day_robert_frank_s_the_american", "title": "Jonathan Day - Robert Frank's 'The Americans' _ The Art of Documentary Photography (2011,", "parts": 2, "units": [{"part": 1, "file": "/tmp/wave002g/parts/jonathan_day_robert_frank_s_the_american_p1.txt", "words": 33251}, {"part": 2, "file": "/tmp/wave002g/parts/jonathan_day_robert_frank_s_the_american_p2.txt", "words": 33251}]}]
...
log(`002-G wave002g-R1 certified+verified: ${passed.length}/${BOOKS.length}; needs-rework: ${failed.length}`)
return {
