...
TOOLS = {
    ...
    "mcp.premiere":   {"kind":"mcp","status":"ACTIVE","call":"node ~/premiere-pro-mcp/dist/index.js","note":"DIRECT Premiere control 269 tools; PROVEN ping->connected (Premiere 26.2.2, project NEW.prproj, activeSequence None) 2026-06-06. Read ACTIVE; edit/export HELD behind approval; gate os_premiere_compliance_gate","approval":"edit-export"},
    "mcp.after_effects":{"kind":"mcp","status":"ACTIVE","call":"node ~/after-effects-mcp/build/index.js","note":"AE control; PROVEN getProjectInfo round-trip via MCP Bridge Auto panel (Untitled Project, 0 items) 2026-06-06. Read ACTIVE; comp-create/render HELD behind approval; in-AE panel must stay open","approval":"comp-render"},
    ...
    "mcp.elevenlabs": {"kind":"mcp","status":"ACTIVE","call":"mcp__ElevenLabs__*","note":"VO/TTS/SFX/voice-clone/ConvAI/outbound-call. PROVEN read-only 2026-06-06: check_subscription (tier FREE, 0/10000 chars, 3 voice slots), list_models (10 incl eleven_v3 + multilingual_v2 + flash_v2_5), search_voices (premade lib). Capital ElevenLabs = absolute-path uvx; lowercase duplicate REMOVED (same key). GENERATION/CALLS HELD: no TTS/SFX/agent/outbound without explicit go. Free tier = no audio spend yet but every generate burns the 10k char/mo cap; cloning + agents need paid. Route os_voice_agent_router, gate os_audio_stack_gate","approval":"generate-call"},
