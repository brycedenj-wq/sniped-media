...
TOOLS = {
    ...
    "os.reference_gate":{"kind":"local","status":"ACTIVE","call":"scripts/os_reference_gate.py","note":"check a built edit vs the craft cards: computes shots/ASL/pacing-contrast from the video + card-backed 9-pt checklist (hook/pacing/transition/audio/typo/grade/variety/believability/no-copy). PROVEN flagged the SOLE film as too slow (ASL 11.7s)"},
