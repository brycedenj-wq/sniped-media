...
def manifest(task, idx, compact=False):
    ...
    if fire:
        ...
        out.append("PROJECT CAPSULE: if this is a client/project task or a messy multi-fact brief, run sniped-project-intake FIRST to build the project capsule (separate truth from noise; project facts stay in the capsule, NOT in the permanent OS doctrine/memory/index). See OS_RUNTIME_CONTRACT.md.")
