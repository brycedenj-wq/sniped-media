...
PROJECTS={
 "video_campaign":["HIGGSFIELD_OPERATOR_LIBRARY","PREMIERE_EDITING_LIBRARY","AFTER_EFFECTS_MOTION_LIBRARY","ADOBE_OPERATOR_LIBRARY","FIGMA_DESIGN_SYSTEM_LIBRARY","SOCIAL_DISTRIBUTION_LIBRARY","COMMERCIAL_CRAFT_LIBRARY"],
 "film":["HIGGSFIELD_OPERATOR_LIBRARY","PREMIERE_EDITING_LIBRARY","AFTER_EFFECTS_MOTION_LIBRARY","ADOBE_OPERATOR_LIBRARY","BLENDER_PRODUCTION_LIBRARY","COMMERCIAL_CRAFT_LIBRARY"],
 "ad":["HIGGSFIELD_OPERATOR_LIBRARY","ADOBE_OPERATOR_LIBRARY","PREMIERE_EDITING_LIBRARY","AFTER_EFFECTS_MOTION_LIBRARY","FIGMA_DESIGN_SYSTEM_LIBRARY","COPYWRITING_LIBRARY","MONEY_OFFER_LIBRARY","COMMERCIAL_CRAFT_LIBRARY"],
 ...
 "social_rollout":["SOCIAL_DISTRIBUTION_LIBRARY","COPYWRITING_LIBRARY","PREMIERE_EDITING_LIBRARY","AFTER_EFFECTS_MOTION_LIBRARY","COMMERCIAL_CRAFT_LIBRARY"],
 "photo_post":["PHOTO_DIRECTION_LIBRARY","ADOBE_OPERATOR_LIBRARY","SOCIAL_DISTRIBUTION_LIBRARY","COPYWRITING_LIBRARY","COMMERCIAL_CRAFT_LIBRARY"],
 ...
 "still_range":["HIGGSFIELD_OPERATOR_LIBRARY","ADOBE_OPERATOR_LIBRARY","PHOTO_DIRECTION_LIBRARY","BLENDER_PRODUCTION_LIBRARY","COMMERCIAL_CRAFT_LIBRARY"],
}
