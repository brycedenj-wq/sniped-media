...
- **Premiere MCP = ACTIVE at READ tier** (proof-tested 2026-06-05 22:31 PDT, PREMIERE_MCP_PROOF.md): bridge live, 4 read-only calls succeeded (ping/version/project/state) on Premiere 26.2.2 b3 / NEW.prproj. Route DIRECT_PREMIERE_AUTOMATED = ACTIVE-READ-PROVEN. WRITE/EDIT tier (import/timeline/sequence/export) is AVAILABLE but UNPROVEN , needs a real edit-and-export proof + os_premiere_compliance_gate before any edit-capability claim. AE MCP still pending (run ae-mcp-setup/setup-mac.sh).
