...
const tiers: Tier[] = [
  {
    name: "The Baseline",
    price: "$275",
    target: "Individuals, headshots, and rapid professional updates.",
    scope: "45-minute expertly directed session, one location.",
    deliverables: "5 final retouched images, selected via a digital proofing gallery.",
  ...
  },
  {
    name: "The Standard",
    price: "$550",
    target: "Families, couples, dancers, and extended lifestyle shoots.",
    scope: "Up to 2 hours with multiple outfits or locations.",
    deliverables: "15 to 20 final retouched images.",
