...
description: |
  ...
  - automating multi-step workflows with AI code agent
  ...
  Keywords: AI agents, WAT framework, AI code agent, sub-agents, agent teams, autonomous agents, agentic workflows, MCP, tool configuration, agent architecture
---
...
**Source Document(s):** ai_agents_extracted.docx
...
5. Configure the Agent: Set up AI code agent or the Agent SDK as the coordinator that reads workflows, selects tools, and handles errors.
6. For sub-agents: Create agent markdown files in .ai-agent/agents/ with name, allowed tools, description, and system prompt. Scope tools per agent.
